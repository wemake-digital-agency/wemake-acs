...
?>
    ...
    <style>
        ...
        <?php if (!empty(get_option('wmacs_set_default_options'))) { ?>html #wemake-acs {
            background: <?php esc_html_e(get_option('wmacs_popup_color')); ?>;
        }

        html .acs-button {
            background: <?php esc_html_e(get_option('wmacs_button_color')); ?>;
            color: <?php echo get_option('wmacs_icon_color'); ?>;
        }

        html .acs-title,
        html .acs-wemake {
            color: <?php esc_html_e(get_option('wmacs_text_color')); ?>;
        }

        html .acs-link,
        html .acs-powered {
            color: <?php esc_html_e(get_option('wmacs_link_color')); ?>;
        }
